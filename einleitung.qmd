...
::: {#wrn-string .callout-warning appearance="simple" collapse="true"}
...
## Aufgaben Slicing
1. Gegeben ist eine Pandas Series 'temperaturen_2021' mit den durchschnittlichen Monatstemperaturen.
...
3. Wählen Sie mit der Methode `.loc[]` die Spalte 'dose' und 'len' des DataFrame meerschweinchen aus und geben Sie die ersten 4 und die letzten 3 Zeilen aus. (Code zum Einlesen der Datei siehe @lst-readfile)  

4. Die Methoden `.loc[]` und `.iloc[]` akzepzieren auch ein boolsches Array als Eingabe. Geben Sie aus der Spalte 'dose' des DataFrame meerschweinchen alle Zeilen mit dem Wert 2.0 aus.
...
1. Fügen Sie Spalten 'len' und 'dose' aus dem DataFrame 'meerschweinchen' ein.
